 ...
 * Bitfield extraction uses the GET/SET/MODIFY macros from the
 * generated hwinc/uart.h header.
 */

#ifndef ERBIUM_API_SHAKTI_UART_H_
#define ERBIUM_API_SHAKTI_UART_H_
...
/* ------------------------------------------------------------------ */
/* V3 TX trigger (HW requirement): after writing TX_REG, must write
 * BAUD, DELAY, IEN, RX_THRESHOLD to start transmission.
 */
...
#endif /* ERBIUM_API_SHAKTI_UART_H_ */
