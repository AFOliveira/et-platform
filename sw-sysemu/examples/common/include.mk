...
ETSOC1_STACK_SIZE_LOG2 ?= 14
# ERBIUM
ERBIUM_BOOT_ADDR      ?= 0x0002008000
ERBIUM_STACK_TOP      ?= 0x000200D000
ERBIUM_STACK_SIZE_LOG2 ?= 6
# Architecture / ABI
...
ETSOC1_LDFLAGS += -DSTACK_BASE=$(ETSOC1_STACK_TOP) -DSTACK_SIZE_LOG2=$(ETSOC1_STACK_SIZE_LOG2)
ERBIUM_LDFLAGS += -Wl,--section-start=bootrom=$(ERBIUM_BOOT_ADDR),--section-start=stack=$(ERBIUM_STACK_TOP) -Tcommon/erbium.ld
ERBIUM_LDFLAGS += -DSTACK_BASE=$(ERBIUM_STACK_TOP) -DSTACK_SIZE_LOG2=$(ERBIUM_STACK_SIZE_LOG2)
